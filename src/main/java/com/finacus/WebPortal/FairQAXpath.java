...
public class FairQAXpath {
	
	public static final String Notifiy1 = "com.android.permissioncontroller:id/permission_allow_button";
	...
	// Call to 'tap' failed 
	//An unknown server-side error occurred while processing the command. Original error: 'POST /element/00000000-0000-001d-ffff-ffff00000031/click' cannot be proxied to UiAutomator2 server because the instrumentation process is not running (probably crashed). Check the server log and/or the logcat output for more details
	
	
	public static final String Notifiy2 = "com.android.permissioncontroller:id/permission_allow_button";
	// xpath = 	/hierarchy/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.ScrollView/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.LinearLayout[2]/android.widget.Button[1]
